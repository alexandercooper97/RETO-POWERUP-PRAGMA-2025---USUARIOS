...
public class RolRestController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<RolResponseDto> obtenerRolById(@PathVariable(value = "id") Long rolId) {
        return  ResponseEntity.ok(rolHandler.obtenerRolById(rolId));
    }
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> eliminarRolById(@PathVariable(value = "id")Long rolId){
        rolHandler.eliminarRolById(rolId);
